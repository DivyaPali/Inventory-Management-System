...
<head>
  ...
  <title>Inventory Management System | Alter Products</title>
</head>
...
<div class="container">
    <div class="card mt-5">
      <div class="card-content">
        <div class="card-title mt-3 center">Alter Products Of Database</div>
        <form class="col" method="POST">
          <div class="row">
            ...
            <div class="input-field col-sm">
              <input type="number" placeholder="New Id" name="np_id">
            </div>
            <div class="input-field col-sm">
            <?php 
            $p_id=intval($_GET['p_id']);
            ...
            <button class="btn btn-secondary ml-2"><a href="./product.php" style="text-decoration:none;color:white;">Back</a></button>      
          </div>
        </form>
      </div>
    </div>
