        ...
        <div class="row" style="margin-left:auto;">
          ...
          <div class="btn-group">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <a class="dropdown-item" href="#" name="highLow">Cost : High To Low</a>
    ...
    <div class="card mt-5">
      ...
      <div class="card-body">
        <table>
          ...
          <tbody>
            <?php $sql = "SELECT * from product_detail ORDER BY p_cost DESC";
            ...
            ?>                                      
              <tr class="odd gradeX">
                ...
                <td class="center">
                  ...
                  <a href="product.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');">       <button class="btn btn-danger"><i class="fa fa-remove"></i> Delete</button>
                  </a>
                </td>
              </tr>
            <?php $cnt=$cnt+1;}}?>                                      
